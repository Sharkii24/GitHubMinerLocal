...
public class IssueReactions {
    ...
    private Integer totalCount; // Hace falta (votes Issue)
    ...
    public String toString() {
        ...
        sb.append(IssueReactions.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
